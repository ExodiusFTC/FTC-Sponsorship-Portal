  ...
  return (
    <div className="space-y-4 max-w-3xl mx-auto">
      {optimisticNotifications.length === 0 ? (
        <div className="text-center text-muted-foreground p-8 border border-dashed border-border rounded-xl bg-card">
            ...
            >
              ...
              {!n.read_at && (
                <button
                  ...
                  className="text-[11px] font-medium text-indigo-400 hover:text-indigo-300 bg-indigo-500/10 hover:bg-indigo-500/20 px-2 py-1 rounded transition-colors whitespace-nowrap shrink-0"
                >
                  Mark as read
                </button>
              )}
